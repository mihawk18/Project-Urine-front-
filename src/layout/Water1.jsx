                ...
                <div className="card shrink-0 w-full max-w-sm bg-white bg-opacity-25  border-[#FFFFFF] border-opacity-40 items-center ">
                    <form className="card-body ">
                        <div className="form-control text-center" style={{ justifyContent: 'space-between', gap: '20px', width: '240px' }}>
                            <button className="btn   text-[#483D8B] font-bold border-2 border-[#FFFFFF] border-opacity-40" onClick={(e) => { e.preventDefault(); window.location.href = 'recomment4'; }} style={myStyle3}>
                                <p>ปกติ<br />(8-10แก้ว/วัน)</p></button>
                            <button className="btn  text-[#483D8B] font-bold border-2 border-[#FFFFFF] border-opacity-40" onClick={(e) => { e.preventDefault(); window.location.href = 'recomment5'; }} style={myStyle3}>
                                <p>น้อย<br />(น้อยกว่า8แก้ว/วัน)</p> </button>
                            <button className="btn  -center text-[#483D8B] font-bold border-2 border-[#FFFFFF] border-opacity-40" onClick={(e) => { e.preventDefault(); window.location.href = 'recomment6'; }} style={myStyle3}>
