...
export default function ShowTime3() {
    const { user } = useAuth();
    ...
    return (
        <div className="min-w-[373px] min-h-[816px] overflow-hidden flex flex-col justify-center items-center " style={myStyle2} >
            <div className="card  w-[338px] min-h-[680px]  items-center justify-center" >
                ...
                {renderTimeSettingCard("00.00", isChecked1, handleToggle1)}
                {renderTimeSettingCard("03.00", isChecked2, handleToggle2)}
                {renderTimeSettingCard("06.00", isChecked3, handleToggle3)}
                {renderTimeSettingCard("09.00", isChecked4, handleToggle4)}
                {renderTimeSettingCard("12.00", isChecked5, handleToggle5)}
