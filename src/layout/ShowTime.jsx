    ...
    return (
        <div className="min-w-[373px] min-h-[816px] overflow-hidden flex flex-col justify-center items-center " style={myStyle2} >
            <div className="card  w-[338px] min-h-[680px]  items-center justify-center" >
                ...
                {renderTimeSettingCard("10.00", isChecked2, handleToggle2)}
                {renderTimeSettingCard("12.00", isChecked3, handleToggle3)}
                {renderTimeSettingCard("14.00", isChecked4, handleToggle4)}
                {renderTimeSettingCard("23.00", isChecked5, handleToggle5)}
